...
ADDITIONAL_BUILD_PROPERTIES := \
    config.disable_bluetooth=yes \
    config.disable_telephony=yes \
    config.disable_location=yes \
...
#     config.disable_systemui=yes \
#     config.disable_noncore=yes \

#predexing means we compile the system apps before distribution
#this dencreases first boot time a /lot/
#but makes installation size a lot higher
...
CUSTOM_MODULES:= Shashlikd bootanimation_shashlik
endif
